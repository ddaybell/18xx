...
module Engine
  module Game
    module Meta
      ...
      # directory name under public/fixtures/ for this game; if not set, the name
      # will be generated by the method fixture_dir_name(). It should have only
      ...
      module ClassMethods
        ...
        def fixture_dir_name
          @fixture_dir_name ||= self::FIXTURE_DIR_NAME || title.gsub(/[^0-9a-z]/i, '')
        end
